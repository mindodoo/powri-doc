...
- [x] **Vercel readiness** (AC: 1, 4)
  ...
  - [x] Extend generated `web/AGENTS.md` with pointers: `architecture.md`, `design.md`, `experience.md`, `docs/analytics/tracking-plan.md`
...
| Rule | Detail |
|------|--------|
| **App location** | All Next.js code lives in **`web/`** — NOT repo root. Keeps `content/`, `docs/`, `_powri/` sibling to app. |
...
Full target structure is in [architecture.md](../planning-artifacts/architecture/phase1/architecture-phase1.md) — implement only what this story requires.
...
Architecture defines this route for all deploy smoke tests [architecture.md § API & Communication](../planning-artifacts/architecture/phase1/architecture-phase1.md).
...
- [architecture.md](../planning-artifacts/architecture/phase1/architecture-phase1.md) — authoritative stack decisions
- [epics.md](../planning-artifacts/epics/phase1/epics-phase1.md) — Story 1.1 AC source
- [implementation-readiness-report-2026-06-12.md](../planning-artifacts/prds/phase1/archive/implementation-readiness-report-2026-06-12.md) — READY WITH MINOR GAPS

### References

- [Source: _powri/planning-artifacts/prds/phase1/prd-phase1.md §7.1 Frontend](../planning-artifacts/prds/phase1/prd-phase1.md)
- [Source: _powri/planning-artifacts/prds/phase1/prd-phase1.md §6.2 HSTS](../planning-artifacts/prds/phase1/prd-phase1.md)
- [Source: architecture.md § Starter Template Evaluation](../planning-artifacts/architecture/phase1/architecture-phase1.md)
- [Source: architecture.md § Project Structure](../planning-artifacts/architecture/phase1/architecture-phase1.md)
- [Source: epics.md § Story 1.1](../planning-artifacts/epics/phase1/epics-phase1.md)
