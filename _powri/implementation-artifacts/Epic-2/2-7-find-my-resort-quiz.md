...
Planning docs updated: quiz results show **podium top 3 only** (not full ranked list). See [`features/quiz/brief.md`](../planning-artifacts/features/quiz/brief.md) § Results podium.
...
3. **Given** four questions  
   ...
   **Then** advances to next question; enums map per `features/quiz/scoring.md`
...
- [x] **Quiz lib** (AC: 3–4)
  - [x] `types.ts`, `questions.ts`, `score.ts` per `features/quiz/scoring.md`
