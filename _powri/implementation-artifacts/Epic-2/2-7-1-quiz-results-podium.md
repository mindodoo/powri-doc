...
- [x] **i18n + validate**
  ...
  - [x] `features/quiz/brief.md` UX note aligned (no Q4 italic)
  - [x] `npm run build` + `npm run lint` + `npm run test:quiz`

## Dev Notes

- Primary spec: `features/quiz/brief.md` § Results reveal + § Results podium
...
- `_powri/planning-artifacts/features/quiz/brief.md` (modified — Q4 typography note)
