...
- **Source param:** Valid values per `docs/analytics/tracking-plan.md`: `card`, `search`, `chat`, `deep_link`. Default `card` for in-app navigation without query param.
- **Out of scope (3.2+):** Season snapshot, highlights, terrain, trail map, Getting There, AI float

### References

- [Source: `_powri/planning-artifacts/epics/phase1/epics-phase1.md` Story 3.1]
- [Source: `mockups/key-resort-detail.html`]
- [Source: `docs/analytics/tracking-plan.md` — `resort_detail_viewed`]
