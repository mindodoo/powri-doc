...
> **AI agents:** Read this shard + linked feature briefs. One story per session (CS → DS → CR). Do **not** load full Phase 1 epic monolith (`epics/phase1/epics-phase1.md`).
...
**And** analytics fires **`home_explore_cta_clicked`** with `{ source: 'home_show_all', visible_count: 5, total_count: 20 }` (add to `docs/analytics/tracking-plan.md` §2)

**And** Home no longer fires `load_more_clicked` for in-page expansion (Explore retains load-more if applicable)

### Data model

Add **`popularity_rank`** (integer 1–20, unique per published resort) to resort frontmatter schema (`web/src/lib/content/schema.ts`, `content-model.md` §4).
...
**Type:** `[cosmetic]` · **FR:** IMP-3 · **Depends on:** none · **Brief:** [`features/quiz/brief.md`](../../../features/quiz/brief.md)
...
**When** dashboards are configured per `docs/analytics/tracking-plan.md` §5  
...
**And** dashboard URLs recorded in `docs/analytics/analytics-verification.md` or `posthog-setup-report.md`
...
**Then** [`docs/qa/phase1/launch-checklist.md`](../../../../../docs/qa/phase1/launch-checklist.md) §deploy lists all required production env vars with descriptions
...
- [ ] `docs/qa/phase1/launch-checklist.md` §4 manual QA executed
- [x] Sprint status: `epic-6: done`

---

**PRD shard:** [`prds/phase1/shards/16-phase1-improvements.md`](../../../prds/phase1/shards/16-phase1-improvements.md)  
**Phase 3 reviews (PO-5):** [`phase-3-user-community.md`](phase-3-user-community.md)  
**Sprint:** [`_powri/implementation-artifacts/sprint-status.yaml`](../../../../implementation-artifacts/sprint-status.yaml)
