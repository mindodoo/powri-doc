...
> **AI agents:** Read this shard only (not full Phase 1 epic monolith (`epics/phase1/epics-phase1.md`)). One story per session. Update `sprint-status.yaml` when starting/completing a story.
...
**Optional analytics:** `nav_menu_opened`, `search_focused` — add to `docs/analytics/tracking-plan.md` if implemented
...
Add to `web/src/lib/content/schema.ts` + `content-model.md` §4:
...
- [ ] `docs/qa/phase1/launch-checklist.md` §4 spot-check on iPhone SE + iPad
- [ ] Sprint status: `epic-7: done`
- [ ] Epic retro: `epic-7-retro-YYYY-MM-DD.md`

---

**PRD shard:** [`prds/phase1/shards/17-phase1-improvements-wave2.md`](../../../prds/phase1/shards/17-phase1-improvements-wave2.md)  
