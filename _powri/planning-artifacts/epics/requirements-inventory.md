...
Phase 2 — auth, saved resorts, map, reviews, passport, trip skeleton, public profile. **Full epics:** [`epics-phase2.md`](phase2/epics-phase2.md).
...
**Architecture:** [`architecture/phase1/architecture-phase1.md`](../architecture/phase1/architecture-phase1.md) · Phase 2 delta [`architecture/phase2/architecture-phase2.md`](../architecture/phase2/architecture-phase2.md)
