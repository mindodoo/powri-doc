...
updated: 2026-06-12
sources:
  - _powri/planning-artifacts/prds/phase1/prd-phase1.md#12-uiux-specification
  - _powri/planning-artifacts/prds/phase1/prd-phase1.md#3-core-features
...
**Analytics:** Instrument per `docs/analytics/tracking-plan.md` §2. Every explicit event respects `consent_state`.
