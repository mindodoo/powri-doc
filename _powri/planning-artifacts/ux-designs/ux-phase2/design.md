...
status: final
updated: 2026-06-23
extends: ../ux-phase1/design.md
sources:
  - prds/phase2/prd-phase2.md
  - prds/phase2/addendum.md
  - epics/phase2/epics-phase2.md
colors:
  badge-bronze: '#B87333'
  badge-silver: '#9CA3AF'
  badge-gold: '#C9A227'
...
> **Base spine:** [`../ux-phase1/design.md`](../ux-phase1/design.md) (Theme A). All `{colors.*}`, `{typography.*}`, `{rounded.*}`, and `{spacing.*}` from Phase 1 apply unless overridden here. **Spines win on conflict** with mocks.
