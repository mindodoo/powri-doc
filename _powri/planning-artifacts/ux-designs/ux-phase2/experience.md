...
status: final
updated: 2026-06-23
extends: ../ux-phase1/experience.md
sources:
...
> **Base spine:** [`../ux-phase1/experience.md`](../ux-phase1/experience.md) (Phase 1). Visual tokens: [`design.md`](design.md) + Phase 1 design.md via `{path.to.token}`. **Spines win on conflict** with mocks.
