...
**Companion to:** [`prds/phase2/prd-phase2.md`](prd-phase2.md)  
...
Align with Powri Theme A ([`prds/phase1/shards/12-ux-theme-and-layout.md`](../phase1/shards/12-ux-theme-and-layout.md)):
...
- AI pulls transport/accommodation suggestions from **seed content first** ([`prds/phase1/shards/08-ai-content.md`](../phase1/shards/08-ai-content.md)).
...
Update [`prds/phase1/shards/11-roadmap-scope.md`](../phase1/shards/11-roadmap-scope.md) and phase-3 epics when Phase 2 PRD is finalized.
...
Map FR-9 requires coordinates in seed content. Add to `content-model.md` §4.1:
...
When implementing, replace `docs/analytics/tracking-plan.md` §3 with PRD §10.4 events. Deprecated / renamed:
