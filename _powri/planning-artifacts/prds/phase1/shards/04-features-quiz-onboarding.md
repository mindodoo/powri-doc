...
**Source:** [`../prd-phase1.md`](../prd-phase1.md) FR-4, FR-5, §12.5 Screen 0/0b  
**Feature brief:** [`features/quiz/brief.md`](../../../features/quiz/brief.md) ← **start here for quiz implementation**  
**Epic:** [`epics/phase1/shards/epic-02-discover.md`](../../../epics/phase1/shards/epic-02-discover.md) Stories 2.1, 2.7
...
- [ ] Ranking per [`../../../features/quiz/scoring.md`](../../../features/quiz/scoring.md)
- [ ] **Results reveal:** Serious header only; Cosmic interstitial + header + subline (required — `features/quiz/brief.md` § Results reveal)
- [ ] **Results podium:** top 3 only — featured #1 + minimal #2/#3; match reason on #1; Browse CTA → Explore (`features/quiz/brief.md` § Results podium)
...
- **4 questions max** per mode — full copy in [`features/quiz/brief.md`](../../../features/quiz/brief.md)
...
**Design tokens:** [`ux-designs/ux-phase1/design.md`](../../../ux-designs/ux-phase1/design.md)
