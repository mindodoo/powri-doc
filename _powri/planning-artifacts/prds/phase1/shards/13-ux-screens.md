...
**Source:** [`../prd-phase1.md`](../prd-phase1.md) §12.5 · **Flows:** [`ux-designs/ux-phase1/experience.md`](../../../ux-designs/ux-phase1/experience.md) · **Mocks:** `ux-designs/.../mockups/`
...
- **Mode toggle:** Serious (default) or Cosmic before Q1 — see [`features/quiz/brief.md`](../../../features/quiz/brief.md)
...
Full Cosmic copy + enum mapping: [`features/quiz/brief.md`](../../../features/quiz/brief.md)
...
Copy and i18n keys: [`features/quiz/brief.md`](../../../features/quiz/brief.md) § Results reveal + § Results podium.
...
**Full prose specs:** [`../prd-phase1.md`](../prd-phase1.md) lines ~996–1127
