...
**Source:** [`../prd-phase1.md`](../prd-phase1.md) §12.0–12.4  
**Implementation authority:** [`ux-designs/ux-phase1/design.md`](../../../ux-designs/ux-phase1/design.md) — **wins on conflict**
...
**Full token table:** DESIGN.md or [`../prd-phase1.md`](../prd-phase1.md) §12.2 Theme A
