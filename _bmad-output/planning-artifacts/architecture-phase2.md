...
inputDocuments:
  - _bmad-output/planning-artifacts/prds/prd-japan_winter_sport-2026-06-23/prd.md
  - _bmad-output/planning-artifacts/prds/prd-japan_winter_sport-2026-06-23/addendum.md
...
| Document | Role |
|----------|------|
| [`architecture.md`](architecture.md) | Phase 1 foundation — still read first |
| **This file** | Phase 2 additions |
| [`prds/prd-japan_winter_sport-2026-06-23/prd.md`](prds/prd-japan_winter_sport-2026-06-23/prd.md) | FR-8–17 product requirements |
| [`prds/.../addendum.md`](prds/prd-japan_winter_sport-2026-06-23/addendum.md) | Badges, UX layout, handoff schemas |
...
Add to `CONTENT_MODEL.md` §4.1 and `web/src/lib/content/schema.ts`:
...
**Authority:** update `docs/tracking-plan.md` §3 before first instrumentation PR.
