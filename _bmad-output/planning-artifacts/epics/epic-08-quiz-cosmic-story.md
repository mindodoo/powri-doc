...
> **AI agents:** Read this shard + [`../prd/18-quiz-cosmic-story-ux.md`](../prd/18-quiz-cosmic-story-ux.md). One story per session. **Do not change `score.ts` enums or weights.**
...
**PRD:** [`../prd/18-quiz-cosmic-story-ux.md`](../prd/18-quiz-cosmic-story-ux.md)
...
- `docs/tracking-plan.md` — document `story_arc_version`
...
**And** [`docs/epic-8-manual-qa-signoff.md`](../../../docs/epic-8-manual-qa-signoff.md) checklist completed
...
Update [`docs/tracking-plan.md`](../../../docs/tracking-plan.md) in Story 8.1.
