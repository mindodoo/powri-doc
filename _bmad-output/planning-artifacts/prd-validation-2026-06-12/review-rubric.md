...
**PRD:** `japan_ski_prd.md` (v1.0 Draft, ~1,333 lines)  
...
§8 file-map is excellent for AI agents and implementers. Content schema (§8.1) mirrors CONTENT_MODEL.md. Tracking plan is externalized.

### Findings
- **high** No glossary — terms like T1/T2/T3, resort slug, gateway city, valley-pass used across §4, §8, §13 without a single definition block. *Fix:* Short glossary appendix or pointer that CONTENT_MODEL.md §2 is canonical for content tiers.
