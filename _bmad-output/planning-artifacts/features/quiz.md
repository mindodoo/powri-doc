...
**Route:** `/quiz` · **Epic 8 (planned):** Cosmic UX v2 → [`../prd/18-quiz-cosmic-story-ux.md`](../prd/18-quiz-cosmic-story-ux.md)
...
> **Phase 1 shipped** disconnected vignettes (phone call, postcard, etc.). **Epic 8 replaces copy** with one storyline — full text in [`../prd/18-quiz-cosmic-story-ux.md`](../prd/18-quiz-cosmic-story-ux.md) §6. Enum keys unchanged.
...
Full text in [`../prd/18-quiz-cosmic-story-ux.md`](../prd/18-quiz-cosmic-story-ux.md) §6. Mixed A/B selections + Scene 4 question update.
...
| **Match reason** | One accent line below name/region — e.g. *"Strong match — powder & terrain"* — from `getMatchReason()` (see [`docs/quiz-scoring.md`](../../../docs/quiz-scoring.md) §4.1) |
...
**Mocks:**  
- [`../ux-designs/ux-japan_winter_sport-2026-06-12/mockups/key-quiz.html`](../ux-designs/ux-japan_winter_sport-2026-06-12/mockups/key-quiz.html)  
- [`../ux-designs/ux-japan_winter_sport-2026-06-12/mockups/key-quiz-results.html`](../ux-designs/ux-japan_winter_sport-2026-06-12/mockups/key-quiz-results.html)
...
**Scoring:** Spec in [`../../../docs/quiz-scoring.md`](../../../docs/quiz-scoring.md) — implement `web/src/lib/quiz/score.ts` against §3. Serious and Cosmic share one algorithm. Validate with Ninja persona (§6) before sign-off.
...
## Persona validation (EXPERIENCE.md + `docs/quiz-scoring.md` §6)
...
| `docs/quiz-scoring.md` | ✅ Weights + persona fixtures — implement `score.ts` against §3 |

**Blocked by:** None (2.6 complete). **Implement against:** [`docs/quiz-scoring.md`](../../../docs/quiz-scoring.md).
...
| Need | Document |
|------|----------|
| FR acceptance checklist | [`../prd/04-features-quiz-onboarding.md`](../prd/04-features-quiz-onboarding.md) |
| Full story + epic context | [`../epics/epic-02-discover.md`](../epics/epic-02-discover.md#story-27) |
| Screen 0b full spec | [`../prd/13-ux-screens.md`](../prd/13-ux-screens.md) |
| Component visual tokens | [`../ux-designs/ux-japan_winter_sport-2026-06-12/DESIGN.md`](../ux-designs/ux-japan_winter_sport-2026-06-12/DESIGN.md) |
| User flows | [`../ux-designs/ux-japan_winter_sport-2026-06-12/EXPERIENCE.md`](../ux-designs/ux-japan_winter_sport-2026-06-12/EXPERIENCE.md) |
| Resort scoring algorithm | [`../../docs/quiz-scoring.md`](../../docs/quiz-scoring.md) |
| Resort content schema | [`../../../content/CONTENT_MODEL.md`](../../../content/CONTENT_MODEL.md) |
| Full PRD §12.5 | [`../prd.md`](../prd.md) Screen 0b |
| Epic 8 Cosmic UX | [`../prd/18-quiz-cosmic-story-ux.md`](../prd/18-quiz-cosmic-story-ux.md) |
| Illustration assets | [`../../../content/quiz-illustrations/README.md`](../../../content/quiz-illustrations/README.md) |
| Epic 8 QA | [`../../../docs/epic-8-manual-qa-signoff.md`](../../../docs/epic-8-manual-qa-signoff.md) |
