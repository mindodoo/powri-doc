...
**Source:** [`../prd.md`](../prd.md) §3 · **Detail shards:** `03-*` through `07-*` · **Epics:** [`../epics/requirements-inventory.md`](../epics/requirements-inventory.md)
...
| **FR-4** | Find My Resort Quiz | 1 | [`04-features-quiz-onboarding.md`](04-features-quiz-onboarding.md) · [`../features/quiz.md`](../features/quiz.md) |
| **FR-5** | Onboarding | 1 | [`04-features-quiz-onboarding.md`](04-features-quiz-onboarding.md) |
| **FR-6** | AI Chat (Resort Q&A) | **3** | [`06-features-ai-chat.md`](06-features-ai-chat.md) · [`../epics/phase-3-monetisation-ai.md`](../epics/phase-3-monetisation-ai.md) |
...
- [ ] Completion → **podium top 3** + **results reveal** (Serious: header; Cosmic: interstitial + header + subline) — see `features/quiz.md` § Results podium
...
- See [`06-features-ai-chat.md`](06-features-ai-chat.md) and [`../epics/phase-3-monetisation-ai.md`](../epics/phase-3-monetisation-ai.md) for full ACs when Phase 3 starts.
