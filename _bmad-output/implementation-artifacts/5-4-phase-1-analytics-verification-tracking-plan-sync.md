...
3. **And** any new/changed events are reflected in `docs/tracking-plan.md`
...
- [x] **Manual E2E checklist** (AC: 1)
  - [x] `docs/analytics-verification.md`
...
- `docs/tracking-plan.md` (modified — §2.1 implementation map)
- `docs/analytics-verification.md` (new)
