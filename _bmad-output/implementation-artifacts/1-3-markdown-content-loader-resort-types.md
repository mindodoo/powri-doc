...
1. **Given** files in `content/resorts/<slug>.md` following `CONTENT_MODEL.md` schema  
   **When** the build runs  
...
3. **Given** PRD §8.1 / `CONTENT_MODEL.md` §4  
...
- [Source: japan_ski_prd.md §8.1](../../japan_ski_prd.md)
- [Source: CONTENT_MODEL.md §4](../../content/CONTENT_MODEL.md)
