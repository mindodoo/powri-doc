...
5. **And** manual smoke checklist in `docs/epic-8-manual-qa-signoff.md` ready for PO pass
...
- [x] Update `docs/epic-8-manual-qa-signoff.md` for revised 8.3 scope + automated pre-flight
...
- `docs/epic-8-manual-qa-signoff.md` (updated)
- `_bmad-output/implementation-artifacts/8-4-cosmic-integration-qa.md` (new)
